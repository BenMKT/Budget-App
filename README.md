...
- [x] Three main models: User, Category, and Transaction, following the ERD diagram.
...
```
git clone git@github.com:BenMKT/Budget-App.git
```
Using HTTPS:

```
git clone https://github.com/BenMKT/Budget-App.git
```

You can also create the new directory just adding the name of it in the end of command. For example:

```
git clone https://github.com/BenMKT/Budget-App Budget-App
```
...
1. Once the setup is complete, ensure you are still in the directory containing the Ultimate Budget Assistant files.
...
5. Alternatively, you could run tests for any specific suit using the following command (an example for User model):
...
Feel free to check the [issues page](https://github.com/BenMKT/Budget-App/issues).
...
If you encounter any issues or have any questions or suggestions, please open an issue on the [issue tracker](https://github.com/BenMKT/Budget-App/issues).
...
- Credit also goes to [Gregoire Vella on Behance](https://www.behance.net/gregoirevella) whose original design was used.
